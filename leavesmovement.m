...
[music_sum,fs_sum] = audioread('송골매_60_percussive.wav');
...
list_instrument = dir('data_augment\*'); %crash, hihat, kick, snare
...
for i = 1:numel(list_instrument)-2
    ...
    for j = 1:numel(list_audio)-2 % 악기 폴더 내 샘플 폴더
        ...
        [beat] = bumblebee_xorr_clustering_islocal(sound_L_sum,sound_L); % xcorr -> islocalmax
